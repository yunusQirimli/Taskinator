...
import com.yunus.qirimli.domain.Project;
import com.yunus.qirimli.repository.ProjectRepository;
...
public class ProjectResourceIT {
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getModificationDate()).isEqualTo(DEFAULT_MODIFICATION_DATE);
    ...
    public void updateProject() throws Exception {
        ...
        assertThat(testProject.getModificationDate()).isEqualTo(UPDATED_MODIFICATION_DATE);
