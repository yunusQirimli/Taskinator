...
import com.yunus.qirimli.domain.Comment;
import com.yunus.qirimli.repository.CommentRepository;
...
/**
 * REST controller for managing {@link com.yunus.qirimli.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
